...
public class MainActivity extends Activity {
    ...
    private static final String DEFAULT_URL = "https://skylar-pairing.vercel.app";
    ...
    private static final String SCHEME = "pairportal";
    ...
    private void configureWebView() {
        ...
        s.setUserAgentString(s.getUserAgentString() + " PairPortal/1.2");
    ...
    /**
     * pairportal://copy?text=CODE   native clipboard copy
     * pairportal://watch?id=..&expires=..   a request just started: protect + notify
     * pairportal://done | stopwatch         the flow finished: unprotect + stop watching
     */
